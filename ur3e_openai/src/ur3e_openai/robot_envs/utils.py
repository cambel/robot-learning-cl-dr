...
def randomize_pose(center_pose, workspace, reset_time, rng):
    ...
    # new_orientation = tr.pose_from_angular_velocity(center_pose, orientation, dt=reset_time, ee_rotation=ee_rotation)
    return tr.pose_euler_to_quaternion(center_pose, rand)
